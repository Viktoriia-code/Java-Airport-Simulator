...
public class EventList {
	 ...
	 */
	public Event remove() {
		Trace.out(Trace.Level.DEBUG,"Removing from the event list " + eventlist.peek().getType() + " " + eventlist.peek().getTime());
	...
	public void add(Event t) {
		Trace.out(Trace.Level.DEBUG,"Adding to the event list " + t.getType() + " " + t.getTime());
		eventlist.add(t);
	}
